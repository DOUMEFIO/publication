<x-app-layout>
    ...
    <div class="col-xxl-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Permet de changer le prix d'une tâche.</p>
                <div class="live-pre
                view">
                    <form method="post" action="{{route('createprice')}}" >
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="firstNameinput" class="form-label">Prix Unitaire de tâche</label>
                                    <input type="float" class="form-control" placeholder="2" id="firstNameinput" name="prixclient">
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="float" class="form-control" placeholder="0,6" id="lastNameinput" name="prixinfluenceur">
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-md-12">
